...
export function calculate(
  ...
  if (menu == "INSS" && submenu == "Cálculo por Margem Disponível") {
    ...
    return [
      ...
      //[2]
      "VALOR CARTÕES: R$ " + formatNumber(inss + beneficios),
      //[3]
      " PARCELA CARTÕES: R$ " + formatNumber(parcelainss + parcelabeneficios),
      //[4]
      "VALOR COMPRAS: R$ " + formatNumber(comprasinss + comprasbeneficios),
      //[5]
      " PARCELA: R$ " +
